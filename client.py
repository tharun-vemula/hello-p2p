# -*- coding: utf-8 -*-
"""
Created on Fri Jul 15 18:17:45 2022
...
class ChatClient(Frame):
  ...
  def initUI(self):
    ...
    bottomLabel = Label(parentFrame, text="Created by Tharun Vemula")
  ...
  def handleSetServer(self):
    ...
    try:
        ...
        thread = Thread(target=self.listenClients,args=())
        thread.start()
        self.serverStatus = 1
  ...
  def listenClients(self):
    while 1:
      ...
      thread = Thread(target=self.handleClientMessages, args=(clientsoc, clientaddr))
      thread.start()
    self.serverSoc.close()
